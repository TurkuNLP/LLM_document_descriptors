...
srun python3 trace_synonym_merges.py \
  --intermediate "../results/disambiguate_merges/traced_lineages/final_trace.jsonl" \
  --final "../results/synonym_merges/synonym_merge_2/force_merge_2/force_merge_2.jsonl" \
  --lineage "../results/synonym_merges/synonym_merge_2/synonym_merge_2_lineage.jsonl" \
