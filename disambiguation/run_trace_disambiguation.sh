...
merge_res_base="../results/disambiguate_merges/test_round_1/results"
...
srun python3 trace_disambiguation_lineages.py \
  ...
  --lineage "$merge_res_base/all_full_lineage.jsonl"\
  --out "../results/disambiguate_merges/traced_lineages/enriched_counts_test.jsonl" \
